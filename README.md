# 洛克王国世界 — 异色/噩梦/保底机制 解包原始数据

本仓库提供《洛克王国世界》异色精灵相关机制的解包原始数据，均从游戏客户端配置表直接导出，未做任何计算或修改。

> **数据版本**：2025 年 S1 赛季（2025-09-01 ~ 2026-05-21）
>
> **配套解析文档**：[B站视频《异色机制完全解析》](#)  （链接待补）
...
### 6. `bonus_pool_conf.csv` — 噩梦球池（7230 个球）
...
数据来自《洛克王国世界》客户端解包，版权归原开发者所有。本仓库仅供学习研究用途。
